...
const LandingPage: React.FC<ApiConfigFormProps> = ({ 
  ...
  // Initialize form with Charles Lightoller's story data
  const [projectData, setProjectData] = useState<ProjectData>(() => {
    const charlesLightollerData: ProjectData = {
        ...
        >
          ...
          >
            <TextArea 
              ...
              showCount
                maxLength={2000}
                value={projectData.storySynopsis}
                onChange={(e) => setProjectData(prev => ({ ...prev, storySynopsis: e.target.value }))}
                style={{ 
                  borderRadius: 12, 
                  fontSize: 15,
                  border: '2px solid #e2e8f0',
